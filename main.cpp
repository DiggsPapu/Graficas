...
using namespace std;
int main (){
    const std::string filename = "./Image/twistDeformationShader.bmp";
    ...
    // Look at 
    render.lookAt(0.0f,0.0f,10.0f,0.2f,0.0f,0.0f);//Medium shot 
    Model model(0.2f,0.0f,0.0f,-90.0f,0.0f,60.0f,0.003f,0.003f,0.003f,"/home/dieggspapu/UVG/Graficas/Obj/10680_Dog_v2.obj",texture1);
